...
function flattenRecursively(arr, counter = 0) {
    ...
    if (counter > 0) {
        ...
        // this will check this new array at the current element for an additional level of nesting
    ...
    // concatenate the contents of the first element
    let firstHalf = arr[0];

    // with the remaining elements of the array
    let arrNew = firstHalf.concat(arr.slice(1))
